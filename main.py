...
from Client.domain.helper_scripts.evolve_pokemon_with_data import evolve_pokemon_with_data
from Client.domain.helper_scripts.execute_ability import execute_ability
import json


#create machop
machop_data: json
with open("Client/json/base_pokemon_data/machop.json") as json_file:
...
with open("Client/json/evolution_data/machoke.json") as json_file:
...
with open("Client/json/evolution_data/machamp.json") as json_file:
    machamp_evolution_data = json.load(json_file)
evolve_pokemon_with_data(pokemon_1, machamp_evolution_data)

#create bellsprout
bellsprout_data: json
with open("Client/json/base_pokemon_data/bellsprout.json") as json_file:
